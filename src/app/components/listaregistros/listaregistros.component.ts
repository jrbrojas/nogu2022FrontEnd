        ...
        },
        {
          table: {
            ...
            body: [
              ...
              [{ text: 'b)', fontSize: sizeText }, { text: ('Doc. Identidad:' + espacio + ' DNI ( ' + (btd == '1' ? marca : '') + ' ), Pasaporte ( ' + (btd == '2' ? marca : '') + ' ), Carné de Extranjería ( ' + (btd == '3' ? marca : '') + ' ), PTP ( ' + (btd == '5' ? marca : '') + ' ), CPP ( ' + (btd == '6' ? marca : '') + ' ), Otros ( ' + (btd == '4' ? marca : '') + ' )'), fontSize: sizeText }, { text: 'Nro.: ' + espacio + '' + basicos.num_documento, fontSize: sizeText }],
